...
%% Change these:
\newcommand{\projecttitle}{The 3D Role-Playing Game}
\newcommand{\projectauthor}{Qi Fu}
\newcommand{\projectsupervisor}{Gerard Harrison}
...
\begin{document}
  \begin{titlepage}
    ...
    \begin{minipage}[t][3cm]{\textwidth}
      ...
      Supervisor : \projectsupervisor \\[0.1cm]
